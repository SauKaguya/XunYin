package com.kaguya.music.player
...
import com.kaguya.music.providers.navidrome.markNavidromeSongAsPlayed
    ...
    private val subrootTracklistItem = MediaItem.Builder()
        ...
        .setMediaMetadata(
            MediaMetadata.Builder()
                ...
                .setTitle("寻音 - All Songs")
                .setArtworkUri(
                    Uri.parse("android.resource://com.kaguya.music/drawable/ic_notification_icon")
                )
                .build()
        )
        .build()
